...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        # --------------------------------------------------------------
        tlcorner=rg.Point(intersection_center.x-(width/2),intersection_center.y-(letter_thickness/2))
        brcorner=rg.Point(tlcorner.x+width,tlcorner.y+letter_thickness)
        self.h_rect=rg.Rectangle(tlcorner,brcorner)
        ndtlcorner=rg.Point(intersection_center.x-(letter_thickness/2),intersection_center.y-(letter_thickness/2))
        ndbrcorner=rg.Point(ndtlcorner.x+letter_thickness,ndtlcorner.y+height)
        self.v_rect=rg.Rectangle(ndtlcorner,ndbrcorner)
        self.intersectionpoint=intersection_center
        self.width=width
        self.height=height
        self.letterthiccc=letter_thickness
        self.fillcolor=''
        self.outlinecolor=''
    ...
    def move_by(self, dx, dy):
        ...
        self.intersectionpoint.x=self.intersectionpoint.x+dx
        self.intersectionpoint.y+self.intersectionpoint.y+dy
    ...
    def clone(self):
        ...
        #     clone.pdf.
        # --------------------------------------------------------------
        clooone=CapitalT(self.intersectionpoint,self.width,self.height,self.letterthiccc)
        clooone.set_colors(self.fillcolor,self.outlinecolor)
        return clooone
