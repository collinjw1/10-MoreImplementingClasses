...
class Line(object):
    ...
    def slope(self):
        ...
        if self.end.x-self.start.x == 0:
            ...
            top=self.end.y-self.start.y
            bottom=self.end.x-self.start.x
            slope=top/bottom
    ...
    def length(self):
        ...
        Type hints:
          :rtype: float
        """
        xx=self.end.x-self.start.x
        yy=self.end.y-self.start.y
        xxs=xx ** 2
        yys=yy ** 2
        lengthsqrd=xxs+yys
    ...
    def midpoint(self):
        ...
        xxh=xx/2
        yyh=yy/2
        mix=self.start.x+xxh
        miy=self.start.y+yyh
        midp=Point(mix,miy)
        return midp
        # --------------------------------------------------------------
        # Done: 11.
